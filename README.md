# tf-atom-wafv2-rule-group-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/actions/workflows/ci.yml)
[![Release](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/actions/workflows/auto-release.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/actions/workflows/auto-release.yml)
[![CodeQL](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/actions/workflows/codeql.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/actions/workflows/codeql.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-wafv2-rule-group-aws)](https://github.com/PlatformStackPulse/tf-atom-wafv2-rule-group-aws/releases)

---

## Purpose

Terraform atom module for a single AWS WAFv2 Rule Group resource. Provides a reusable collection of WAF rules that can be referenced from multiple Web ACLs.
...
|------|-------------|------|---------|:--------:|
| <a name="input_capacity"></a> [capacity](#input\_capacity) | WCU capacity of the rule group. | `number` | n/a | yes |
| <a name="input_scope"></a> [scope](#input\_scope) | Scope of the Rule Group. Valid values: REGIONAL, CLOUDFRONT. | `string` | n/a | yes |
| <a name="input_attributes"></a> [attributes](#input\_attributes) | ID element. Additional attributes (e.g. `workers` or `cluster`) to add to `id`,<br/>in the order they appear in the list. New attributes are appended to the<br/>end of the list. The elements of the list are joined by the `delimiter`<br/>and treated as a single ID element. | `list(string)` | `[]` | no |
| <a name="input_cloudwatch_metrics_enabled"></a> [cloudwatch\_metrics\_enabled](#input\_cloudwatch\_metrics\_enabled) | Whether CloudWatch metrics are enabled. | `bool` | `true` | no |
...
| <a name="input_description"></a> [description](#input\_description) | Description of the rule group. | `string` | `""` | no |
...
| <a name="input_rules"></a> [rules](#input\_rules) | List of rule configurations for the rule group. | `list(any)` | `[]` | no |
...
| <a name="output_rule_group_arn"></a> [rule\_group\_arn](#output\_rule\_group\_arn) | The ARN of the WAFv2 Rule Group. |
| <a name="output_rule_group_capacity"></a> [rule\_group\_capacity](#output\_rule\_group\_capacity) | The capacity of the rule group. |
| <a name="output_rule_group_id"></a> [rule\_group\_id](#output\_rule\_group\_id) | The ID of the WAFv2 Rule Group. |
<!-- END_TF_DOCS -->
