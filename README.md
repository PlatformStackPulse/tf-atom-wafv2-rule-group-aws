...
| Name | Type |
|------|------|
| [aws_wafv2_rule_group.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/wafv2_rule_group) | resource |
...
| <a name="input_rules"></a> [rules](#input\_rules) | List of rule definitions for the rule group. | `any` | `[]` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | The ARN of the rule group. |
| <a name="output_capacity"></a> [capacity](#output\_capacity) | The WCU capacity of the rule group. |
